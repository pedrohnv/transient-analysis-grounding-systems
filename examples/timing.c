...
run_timing (int intg_type, char *file_name, unsigned int loops)
{
    ...
    for (unsigned int i = 0; i < loops; i++) {
        begin = clock();
        run_grcev51emc03(10.0, 10.0, "grcev51emc03_L10rho10.dat", intg_type);
        end = clock();
    ...
    for (unsigned int i = 0; i < loops; i++) {
        begin = clock();
        run_grcev51emc03(10.0, 100.0, "grcev51emc03_L10rho100.dat", intg_type);
        end = clock();
        time_spent = (double) (end - begin)/CLOCKS_PER_SEC;
        fprintf(save_file, "%f\n", time_spent);
    }
    ...
    for (unsigned int i = 0; i < loops; i++) {
        begin = clock();
        run_grcev51emc03(10.0, 1000.0, "grcev51emc03_L10rho1000.dat", intg_type);
        end = clock();
        time_spent = (double) (end - begin)/CLOCKS_PER_SEC;
        fprintf(save_file, "%f\n", time_spent);
    }
    ...
    for (unsigned int i = 0; i < loops; i++) {
        begin = clock();
        run_grcev51emc03(100.0, 10.0, "grcev51emc03_L100rho10.dat", intg_type);
        end = clock();
        time_spent = (double) (end - begin)/CLOCKS_PER_SEC;
        fprintf(save_file, "%f\n", time_spent);
    }
    ...
    for (unsigned int i = 0; i < loops; i++) {
        begin = clock();
        run_grcev51emc03(100.0, 100.0, "grcev51emc03_L100rho100.dat", intg_type);
        end = clock();
        time_spent = (double) (end - begin)/CLOCKS_PER_SEC;
        fprintf(save_file, "%f\n", time_spent);
    }
    ...
    for (unsigned int i = 0; i < loops; i++) {
        begin = clock();
        run_grcev51emc03(100.0, 1000.0, "grcev51emc03_L100rho1000.dat", intg_type);
        end = clock();
        time_spent = (double) (end - begin)/CLOCKS_PER_SEC;
        fprintf(save_file, "%f\n", time_spent);
    }
    ...
    for (unsigned int i = 0; i < loops; i++) {
        begin = clock();
        run_grcev20pwrd02(3.0, 10.0, "grcev20pwrd02_L3rho10.dat", intg_type);
        end = clock();
        time_spent = (double) (end - begin)/CLOCKS_PER_SEC;
        fprintf(save_file, "%f\n", time_spent);
    }
    ...
    for (unsigned int i = 0; i < loops; i++) {
        begin = clock();
        run_grcev20pwrd02(3.0, 100.0, "grcev20pwrd02_L3rho100.dat", intg_type);
        end = clock();
        time_spent = (double) (end - begin)/CLOCKS_PER_SEC;
        fprintf(save_file, "%f\n", time_spent);
    }
    ...
    for (unsigned int i = 0; i < loops; i++) {
        begin = clock();
        run_grcev20pwrd02(3.0, 1000.0, "grcev20pwrd02_L3rho1000.dat", intg_type);
        end = clock();
        time_spent = (double) (end - begin)/CLOCKS_PER_SEC;
        fprintf(save_file, "%f\n", time_spent);
    }
    ...
    for (unsigned int i = 0; i < loops; i++) {
        begin = clock();
        run_grcev20pwrd02(24.0, 10.0, "grcev20pwrd02_L24rho10.dat", intg_type);
        end = clock();
        time_spent = (double) (end - begin)/CLOCKS_PER_SEC;
        fprintf(save_file, "%f\n", time_spent);
    }
    ...
    for (unsigned int i = 0; i < loops; i++) {
        begin = clock();
        run_grcev20pwrd02(24.0, 100.0, "grcev20pwrd02_L24rho100.dat", intg_type);
        end = clock();
        time_spent = (double) (end - begin)/CLOCKS_PER_SEC;
        fprintf(save_file, "%f\n", time_spent);
    }
    ...
    for (unsigned int i = 0; i < loops; i++) {
        begin = clock();
        run_grcev20pwrd02(24.0, 1000.0, "grcev20pwrd02_L24rho1000.dat", intg_type);
        end = clock();
        time_spent = (double) (end - begin)/CLOCKS_PER_SEC;
        fprintf(save_file, "%f\n", time_spent);
    }
